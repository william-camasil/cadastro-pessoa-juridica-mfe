...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      name: "cadastro_pessoa_juridica_mfe", // This application named 'cadastro_pessoa_juridica_mfe'
      filename: "remoteEntry.js", // output a js file
      exposes: {
        // which exposes
        "./CadPessoaJuridicaScreen": "./src/App", // a module 'CadPessoaJuridicaScreen' from './src/App'
      },
      shared: {
        // and shared
